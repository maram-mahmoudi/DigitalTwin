        ...
        if (joint.jointType != ArticulationJointType.FixedJoint)
        {
            if (controltype == Unity.Robotics.UrdfImporter.Control.ControlType.PositionControl)
            {
                ...
                if (joint.jointType == ArticulationJointType.RevoluteJoint)
                {
                    ...
                    // Debug.Log("Revolute" + currentDrive.target + "\n");
                }

                else if (joint.jointType == ArticulationJointType.PrismaticJoint)
                //Debug.Log("asat" + newTargetDelta + "  dir" + direction + " ss" + speed + " ff" + Time.fixedDeltaTime);
                {
                    ...
                    // Debug.Log("primastic" + currentDrive.target + "\n");
