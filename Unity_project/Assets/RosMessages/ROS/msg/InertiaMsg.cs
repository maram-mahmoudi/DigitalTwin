...
namespace RosMessageTypes.ROS
{
    ...
    {
        public const string k_RosMessageName = "ROS/Inertia";
        public override string RosMessageName => k_RosMessageName;

        //  Mass [kg]
        public double m;
        //  Center of mass [m]
        public Geometry.Vector3Msg com;
        ...
        {
            this.m = 0.0;
            this.com = new Geometry.Vector3Msg();
            this.ixx = 0.0;
            this.ixy = 0.0;
            this.ixz = 0.0;
            this.iyy = 0.0;
        ...
        public InertiaMsg(double m, Geometry.Vector3Msg com, double ixx, double ixy, double ixz, double iyy, double iyz, double izz)
        {
            this.m = m;
            this.com = com;
            this.ixx = ixx;
        ...
        private InertiaMsg(MessageDeserializer deserializer)
        {
            ...
            this.com = Geometry.Vector3Msg.Deserialize(deserializer);
